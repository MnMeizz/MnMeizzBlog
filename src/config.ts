...
export const siteConfig: SiteConfig = {
	title: "MnMeizz",
	subtitle: "Blog",
	siteURL: "https://mnmeizz.online", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "1201966", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				"あなたの心の中に、私が永遠に住めますように",
				"今でもあなたは私の光",
				"君ってさ、知らないうちに私の毎日になってたよ",
				"君と話すと、なんか毎日がちょっと楽しくなるんだ",
				"どんなに遠くにいても、あなたを想う気持ちが私を生かしています",
			],
			typewriter: {
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/MnMeizz",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/282601111",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://github.com/MnMeizz/MnMeizz.github.io",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/icon.gif", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "MnMeizz",
	bio: "Cause now I know that pain cannot define the past",
	typewriter: {
	...
	links: [
		...
		},
		{
			...
			url: "tencent://message/?uin=1059809116&Site=qq&Menu=yes",
		},
	],
};
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://mnmei-twikooplugins.hf.space",
		lang: "zh-CN",
	},
};
...
export const umamiConfig = {
	...
	apiKey: import.meta.env.UMAMI_API_KEY || "api_lGglnhNSQtygNw71elP6a8kT7SyHawlf", // API密钥优先从环境变量读取，否则使用配置文件中的值
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: `
<script defer src="https://cloud.umami.is/script.js"     data-website-id="833171f4-58a0-4fda-be9c-e48e27e68e4b"></script>
